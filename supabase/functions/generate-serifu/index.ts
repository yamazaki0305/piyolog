...
- 自分たちの子育ての話は、寝かしつけ・離乳食・抱っこなどの日常のささやかなエピソードにとどめ、今日の記録につなげて「うちもそうだよ」と共感する形にする。この話に数字は使わない。作り話でよいが、この赤ちゃんについての事実として語らない。
- 自分たちの子どもと比べて、この赤ちゃんの成長を評価したり、育児のやり方を指示・助言したりしない。
